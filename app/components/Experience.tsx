  ...
  return (
    <div className="space-y-6">
      ...
      <section className="bg-white p-4 rounded-lg shadow-lg text-black md:p-6">
        ...
        {expError && (
          <p className="text-red-500">Could not load experience data.</p>
        )}
      ...
      <section className="bg-white p-4 rounded-lg shadow-lg text-black md:p-6">
        ...
        {skillsLoading && (
          <p className="text-gray-400 animate-pulse mt-4">Loading skills...</p>
        )}
        {skillsError && (
          <p className="text-red-500 mt-4">Could not load skills data.</p>
        )}
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
          {skillCategories?.map((category) => (
            <div
              key={category._id}
              className="p-6 rounded-lg shadow-md bg-slate-50"
            >
